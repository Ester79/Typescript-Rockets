...
var Cohete = /** @class */ (function () {
    ...
    Cohete.prototype.mostrarInfo = function () {
        ...
        return "Code: " + this.codigo + "<br>" + "Current/Maximum Boosters power: " + infoPropulsores + "<br>" + "Maximum Power:" + this.potenciaTotalMaxima() + "<br>" + "Current Power:" + this.potenciaTotalActual();
    };
    return Cohete;
}());
